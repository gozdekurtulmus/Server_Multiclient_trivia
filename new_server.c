...
int main(int argc, char *argv[])
{
    ...
    *shared_question_number = 0;
    ...
    int sockfd, newsockfd, portno, pid, n, client_index;
    socklen_t clilen;
    char buffer[256];
                ...
                *shared_connection_counter+=1;
                ...
                while(1){
                    ...
                    *shared_answer_counter +=1;
                    ...
                    {
                        printf(stderr,"%i, %i", *shared_answer_counter, shared_connection_counter);
                        sleep(1/2);
                    }
                    ...
                    *shared_answer_counter = 0;
                    ...
                    if(question == MAX_QUESTIONS){break;}
                ...
                sprintf(buffer+ strlen(buffer), "\n\nGame is finshed.");
                n = write(newsockfd, buffer, strlen(buffer));
                printf("%s is removed from the server.", clients[client_index].name);
                close(newsockfd);
